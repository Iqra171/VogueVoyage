    ...
    <div class="container">
        <div class="div-item">
            <form action="#" method="POST">
                ...
                <br>
                <label>Number:</label>
               <input type="password" id="pass" name="pass" minlength="8" maxlength="20"  value="<?php  echo isset($result['email']) ? htmlspecialchars($result['email']) : '';?>"required><br><br>
...
if (isset($_POST["update" ])) {
    ...
    $query = "INSERT INTO signup (name, email, password) VALUES ('$fname', '$femail', '$password')";
    $query= "UPDATE signup SET name='$fname',email='$femail',password='$pass' where id ='$id'";
    $data = mysqli_query($conn, $query);
    if ($data) {
        echo 'updatedd';
    } else {
