...
<body>
  ...
  <input type="tel" id="tel" name="tel" maxlength="11" size="11" required><br><br>
   ...
   <label><input type="radio" name="location" id="location" value="Shangrilla, Gilgit"  required> Shangrilla, Gilgit</label><br>
