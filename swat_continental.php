...
<body>
  <header>
    ...
    <nav class="navigation">
      <ul>
        ...
        <li> <a href="swat.html" >SERVICES</a></li>
  ...
  <input type="tel" id="tel" name="tel" maxlength="11" size="11" required><br><br>
   ...
   <label><input type="radio" name="location" id="location" value="SWAT CONTINENTAL"  required> SWAT CONTINENTAL</label><br>
